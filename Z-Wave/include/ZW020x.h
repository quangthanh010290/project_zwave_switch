 ...
 *---------------------------------------------------------------------------
 *
 * Description: Inventra 8051 SFR defines for the Z-Wave ZW020x RF transceiver.
 *
 * Author:   Ivar Jeppesen
 *
 * Last Changed By:  $Author: jfr $
 * Revision:         $Revision: 8256 $
 * Last Changed:     $Date: 2006-11-22 15:18:00 +0100 (on, 22 nov 2006) $
 *
 ****************************************************************************/
#ifndef _ZW020X_H_
#define _ZW020X_H_
